...
import com.bestpickindia.android.bestpick.StoresTab.RecyclerViewAdapterStores;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener  {
        ...
        public void onClick(View v) {
            ...
            MainActivity storeActivity = (MainActivity)context;
            ...
            switch (getPosition()){
                ...
                case 3:
                    ...
                    fragmentTransaction.replace(R.id.containerView,notificationsFragment);
                    fragmentTransaction.commit();
                    break;
                case 4:
                    Fragment favouritesFragment = new FavouritesFragment();
                    fragmentTransaction.replace(R.id.containerView,favouritesFragment);
                    fragmentTransaction.commit();
                    break;
                case 5:
                    Fragment inviteFragment = new InviteFragment();
                    fragmentTransaction.replace(R.id.containerView,inviteFragment);
                    fragmentTransaction.commit();
                    break;
                case 6:
                ...
                case 7:
                    ...
                    fragmentTransaction.replace(R.id.containerView,feedbackFragment);
                    fragmentTransaction.commit();
                    break;
                case 8:
